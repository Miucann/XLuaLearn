...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp12(string p0, out string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(GetLuaFunction.Add))
			{
			    return new GetLuaFunction.Add(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(GetLuaFunction.MultipleReturn))
			{
			    return new GetLuaFunction.MultipleReturn(__Gen_Delegate_Imp12);
			}
